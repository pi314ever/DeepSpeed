...
g1_lazy_xfail_tests = {
    ...
    "float16/half is not supported on Gaudi.",
    "unit/inference/test_inference.py::TestAutoTensorParallelism::test[fp16-marian-False]":
    "float16/half is not supported on Gaudi.",
    ...
    "float16/half is not supported on Gaudi.",
    "unit/inference/test_inference.py::TestAutoTensorParallelism::test[fp16-codegen-False]":
    "float16/half is not supported on Gaudi.",
    ...
    "unit/inference/test_checkpoint_sharding.py::TestCheckpointShardinAutoTP::test[bigscience/bloom-560m-False]":
    "Xfail due to FP16 not supported",
    "unit/inference/test_inference.py::TestAutoTensorParallelism::test_odd_world_size[fp16-marian-False]":
    "xfail due to FP16 not supported",
